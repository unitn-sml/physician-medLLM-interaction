...
@register_task("pubmedqa_long_binary_case2b")
class PubmedqaLongBinaryCase2b(Task):
    VERSION = 0
    ...
    def doc_to_text(self, doc):
        doc_context = "\n".join(doc["CONTEXTS"])
        #input for case b
        u = "Context: [{}], Question: {}, Answer: {}, Explanation: {}".format(doc_context, doc["QUESTION"], reverse_answer(doc["final_decision"]), doc["gpt_wrong_long_answer"])
    ...
    def process_results(self, doc, results):
        ...
        with open("path_to_your_output_directory/modelName_case2/pubmedqa_long_binary_case2b_1.json", "w") as outfile: 
