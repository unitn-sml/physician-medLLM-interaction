...
@register_task("pubmedqa_long_binary_case2a")
class PubmedqaLongBinaryCase2a(Task):
    VERSION = 0
    ...
    def doc_to_text(self, doc):
        doc_context = "\n".join(doc["CONTEXTS"])
        #input for Case a
        u = {"Context": [{doc_context}], "Question": {doc["QUESTION"]}, "Answer": {doc["final_decision"]}, "Explanation": {doc["gpt4_correct_long_answer"]}}
    ...
    def process_results(self, doc, results):
        ...
        with open("path_to_your_output_directory/modelName_case2/pubmedqa_long_binary_case2a_1.json", "w") as outfile: 
