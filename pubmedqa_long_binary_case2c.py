...
@register_task("pubmedqa_long_binary_case2c")
class PubmedqaLongBinaryCase2c(Task):
    VERSION = 0
    DATASET_PATH = "add_path_to_dataset_pubmed_qa_labeled_fold0_source_gpt4_long_answers"
    ...
    def doc_to_text(self, doc):
        ...
        #input for case c
        if doc["final_decision"] == "yes":
            u = "Context: [{}], Question: {}, Answer: {}, Explanation: {}".format(doc_context, doc["QUESTION"], "yes", doc["gpt4_correct_long_answer"])
        else:
            u = "Context: [{}], Question: {}, Answer: {}, Explanation: {}".format(doc_context, doc["QUESTION"], "yes", doc["gpt_wrong_long_answer"])
    ...
    def process_results(self, doc, results):
        ...
        with open("path_to_your_output_directory/modelName_case2/pubmedqa_long_binary_case2c_1.json", "w") as outfile: 
